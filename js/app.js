...
const envData = {
  domain: { name:'CORP.LOCAL', netbios:'CORP', forest:'CORP.LOCAL', functionalLevel:'', adfsUrl:'', adSync:'', dcs:[], sites:[], trusts:[] },
  stats:[], anomalies:[], segments:[], assets:[], accounts:[], topology:'', infrastructure:[],
};
