...
function updateAgentPills(i) {
  const pills = [
    ...
    { hyp:['Running','chip-blue',30,'Analysing CTI · 8 TTPs queued'],               orch:['Running','chip-blue',50,'Routing tasks · pipeline initialised'],  data:['Running','chip-blue',50,'Connecting to Splunk ES…'],              ts:['Waiting','chip-gray',0,'Awaiting TTPs'],               dl:['Waiting','chip-gray',0,'Awaiting investigation notes'] },
    // step 1: TTPs loaded from upstream pipeline, hypothesis agent working
    { hyp:['Running','chip-blue',70,'Cross-referencing past hunts · 3 recalled'],     orch:['Running','chip-blue',70,'Routing tasks · 2 agents active'],        data:['Done','chip-green',100,'Splunk data ready · indices available'], ts:['Waiting','chip-gray',0,'Awaiting hypotheses'],          dl:['Waiting','chip-gray',0,'Awaiting investigation notes'] },
    // step 2: hypotheses generated by Hypothesis Agent
    { hyp:['Done','chip-green',100,'4 hypotheses generated · handed to Orchestrator'],orch:['Done','chip-green',100,'Hypotheses routed · pipeline continues'],   data:['Done','chip-green',100,'Splunk data available · CIM-normalised'], ts:['Review','chip-blue',80,'4 hypotheses ready for review'], dl:['Waiting','chip-gray',0,'Awaiting investigation notes'] },
    // step 3: tradecraft running
    { hyp:['Done','chip-green',100,'4 hypotheses generated · analyst notes applied'], orch:['Done','chip-green',100,'Hunt coordinated · all tasks routed'],     data:['Done','chip-green',100,'Splunk data available · CIM-normalised'], ts:['Active','chip-blue',100,'Retrieving alerts · 59 hits'],  dl:['Running','chip-blue',40,'Awaiting investigation notes'] },
    // step 4: detection logic + rule validation (via tool)
    { hyp:['Done','chip-green',100,'4 hypotheses generated · analyst notes applied'], orch:['Done','chip-green',100,'Hunt coordinated · all tasks routed'],     data:['Done','chip-green',100,'Splunk data available · CIM-normalised'], ts:['Done','chip-green',100,'Investigation complete'],  dl:['Active','chip-blue',90,'Generating rules · validating via RuleVal tool…'] },
  ];
